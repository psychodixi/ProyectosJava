    ...
    if (confirmar = true && res !=2) {
        ...
        switch (opc) {
            case 1:
                ...
                } while (claveCorrecta == false || contUno !=0 || contDos !=0 || res != 2 || confirmar == true);
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.println("GRACIAS POR UTILIZAR NUESTRO SISTEMA DE BANCO XILENO\n"
                        + "<============================>\n"
        ...
        res = input.nextInt();
            ...
            System.out.println("<===============>\n"
                    + "SE HA CERRADO LA SESIÓN POR SEGURIDAD\n"
